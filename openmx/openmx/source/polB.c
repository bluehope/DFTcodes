                        ...
                        for (h_AN=0; h_AN<=FNAN[ct_AN]; h_AN++) {
                            ...
                            for (i1=0; i1<tnoA; i1++) {
                                for (j1=0; j1<tnoB; j1++) {
                                    ...
                                    tmp1r = Wk1[spin][mu1][Bnum+j1].r*Wk2[spin][mu2][Anum+i1].r
                                            + Wk1[spin][mu1][Bnum+j1].i*Wk2[spin][mu2][Anum+i1].i;
                                    tmp1i = Wk1[spin][mu1][Bnum+j1].r*Wk2[spin][mu2][Anum+i1].i
                                            - Wk1[spin][mu1][Bnum+j1].i*Wk2[spin][mu2][Anum+i1].r;
                    ...
                    for (h_AN=0; h_AN<=FNAN[ct_AN]; h_AN++) {
                        ...
                        for (i1=0; i1<tnoA; i1++) {
                            for (j1=0; j1<tnoB; j1++) {
                                ...
                                tmp1r = Wk1[0][mu1][Bnum      +j1].r*Wk2[0][mu2][Anum      +i1].r
                                        + Wk1[0][mu1][Bnum      +j1].i*Wk2[0][mu2][Anum      +i1].i
                                        + Wk1[0][mu1][Bnum+fsize+j1].r*Wk2[0][mu2][Anum+fsize+i1].r
                                        + Wk1[0][mu1][Bnum+fsize+j1].i*Wk2[0][mu2][Anum+fsize+i1].i;

                                tmp1i = Wk1[0][mu1][Bnum      +j1].r*Wk2[0][mu2][Anum      +i1].i
                                        - Wk1[0][mu1][Bnum      +j1].i*Wk2[0][mu2][Anum      +i1].r
                                        + Wk1[0][mu1][Bnum+fsize+j1].r*Wk2[0][mu2][Anum+fsize+i1].i
                                        - Wk1[0][mu1][Bnum+fsize+j1].i*Wk2[0][mu2][Anum+fsize+i1].r;
