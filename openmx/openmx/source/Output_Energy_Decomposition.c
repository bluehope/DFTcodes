        ...
        if (myid==ID) {
            ...
            if (SpinP_switch==0) {
                ...
                for (i=0; i<Spe_Total_CNO[wan1]; i++) {
                    tmp_array0[num] = 2.0*DecEkin[0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEna[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEnl[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEdee[0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecExc[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEscc[0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEef[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEhub[0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEcs[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEzs[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEzo[ 0][Mc_AN][i];
                    num++;
                    tmp_array0[num] = 2.0*DecEvdw[0][Mc_AN][i];
                    num++;
                }
            }
                ...
                for (i=0; i<Spe_Total_CNO[wan1]; i++) {
                    tmp_array0[num] = DecEkin[0][Mc_AN][i] + DecEkin[1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEna[ 0][Mc_AN][i] + DecEna[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEnl[ 0][Mc_AN][i] + DecEnl[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEdee[0][Mc_AN][i] + DecEdee[1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecExc[ 0][Mc_AN][i] + DecExc[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEscc[0][Mc_AN][i] + DecEscc[1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEef[ 0][Mc_AN][i] + DecEef[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEhub[0][Mc_AN][i] + DecEhub[1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEcs[ 0][Mc_AN][i] + DecEcs[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEzs[ 0][Mc_AN][i] + DecEzs[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEzo[ 0][Mc_AN][i] + DecEzo[ 1][Mc_AN][i];
                    num++;
                    tmp_array0[num] = DecEvdw[0][Mc_AN][i] + DecEvdw[1][Mc_AN][i];
                    num++;
                }
            }
