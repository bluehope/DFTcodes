...
double MD_pac(int iter, char *fname_input)
{
    ...
    ***********************************************/
    ...
    switch (MD_switch) {
    case  0:
        NoMD(iter+MD_Current_Iter);
        break;
    case  1:
        VerletXYZ(iter+MD_Current_Iter);
        break;
    case  2:
        NVT_VS(iter+MD_Current_Iter);
        break;  /* added by mari */
    case  3:
        Steepest_Descent(iter+MD_Current_Iter,1);
        break;
    case  4:
        Geometry_Opt_DIIS_EF(iter+MD_Current_Iter);
        break;
    case  5:
        Geometry_Opt_DIIS_BFGS(iter+MD_Current_Iter);
        break;
    case  6:
        Geometry_Opt_RF(iter+MD_Current_Iter);
        break;  /* added by hmweng */
    case  7:
        Geometry_Opt_DIIS(iter+MD_Current_Iter);
        break;
    case  8:
        break;  /* not used */
    case  9:
        NVT_NH(iter+MD_Current_Iter);
        break;
    case 10:
        break;  /* not used */
    case 11:
        NVT_VS2(iter+MD_Current_Iter);
        break;  /* added by Ohwaki */
    case 12:
        EvsLC(iter);
        break;
    case 14:
        NVT_VS4(iter+MD_Current_Iter);
        break;  /* added by Ohwaki */
    case 15:
        NVT_Langevin(iter+MD_Current_Iter);
        break;  /* added by Ohwaki */
    case 16:
        Delta_Factor(iter);
        break;  /* delta-factor */
    case 17:
        Cell_Opt_SD(iter+MD_Current_Iter,1);
        break;
    case 18:
        Cell_Opt_RF(iter+MD_Current_Iter);
        break;
    }
