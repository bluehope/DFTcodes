        ...
        if (myid == Host_ID) {
            ...
            **************************************************************************/
            ...
            if (outputlev==1) {
                ...
                for (Gc_AN=1; Gc_AN<=atomnum; Gc_AN++) {
                    ...
                    for (L1=0; L1<=Spe_MaxL_Basis[wan1]; L1++) {
                        for (M1=1; M1<=2*L1+1; M1++) {
                            printf(" Posi_alm[%d][%d][%d] = %d \n",Gc_AN,L1,M1,Posi_alm[Gc_AN][L1][M1]);
                            fflush(stdout);
                        } /* M1 */
                    } /* L1 */
                } /* Gc_AN */
            ...
            for (Gc_AN=1; Gc_AN<=atomnum; Gc_AN++) {
                ...
                for (L1=0; L1<=Spe_MaxL_Basis[wan1]; L1++) {
                    ...
                    *******************************************/
                    ...
                    for (i=1; i<=Mmax1; i++) {
                        if (W_alm2[0][i] >= thredens) {
                            M_or_R1[Gc_AN][L1][i-1] = 1;
                        }
                        else                          {
                            M_or_R1[Gc_AN][L1][i-1] = 0;
                        }
                    } /* i */
                ...
                for (Gc_AN=1; Gc_AN<=atomnum; Gc_AN++) {
                    ...
                    for (L1=0; L1<=Spe_MaxL_Basis[wan1]; L1++) {
                        ...
                        for (M1=1; M1<=L1*2+1; M1++) {
                            for (i=0; i<leng1; i++) {
                                for (j=0; j<leng1; j++) {
                                    printf("%9.5f",S_alm[0][Gc_AN][L1][M1][i][j]);
                                    fflush(stdout);
                                }
                                printf("\n");
                                fflush(stdout);
                ...
                for (L1=0; L1<=Spe_MaxL_Basis[wan1]; L1++) {
                    ...
                    if (Mmax2 != 0) {
                        ...
                        if (outputlev==1) {
                            ...
                            for (i=0; i<Mmax2; i++) {
                                for (j=0; j<Mmax2; j++) {
                                    printf("%16.12f",S_alm2[0][i+1][j+1]);
                                    fflush(stdout);
                                } /* j */
                                printf("\n");
                                fflush(stdout);
                            ...
                            for (i=0; i<Mmax2; i++) {
                                for (j=0; j<Mmax2; j++) {
                                    printf("%16.12f",P_alm2[0][i+1][j+1]);
                                    fflush(stdout);
                                } /* j */
                                printf("\n");
                                fflush(stdout);
            ...
            *****************************/
            ...
            for (Gc_AN=1; Gc_AN<=atomnum; Gc_AN++) {
                ...
                fflush(stdout);
                for (i=0; i<Leng_a[Gc_AN]; i++) {
                    printf("%8.4f",P_full[0][Posi_a[Gc_AN]+i][Posi_a[Gc_AN]+i]);
                    fflush(stdout);
                }
                printf("\n");
                fflush(stdout);
                ...
                fflush(stdout);
                for (i=0; i<Leng_a[Gc_AN]; i++) {
                    printf("%8.4f",H_full[0][Posi_a[Gc_AN]+i][Posi_a[Gc_AN]+i]);
                    fflush(stdout);
                }
                printf("\n");
                fflush(stdout);
                ...
                for (L1=0; L1<=Spe_MaxL_Basis[wan1]; L1++) {
                    ...
                    for (M1=1; M1<=2*L1+1; M1++) {
                        for (i=1; i<=leng1; i++) {
                            printf(" %s %3s   ",Name_Multiple[i],Name_Angular[L1][M1-1]);
                            fflush(stdout);
                            for (j=0; j<Leng_a[Gc_AN]; j++) {
                                printf("%8.4f",T_full[0][Posi_a[Gc_AN]+k][Posi_a[Gc_AN]+j]);
                                fflush(stdout);
                            } /* j */
                            k++;
                            printf("\n");
            ...
            if(NAO_only==0) {
                ...
                *********************************************************************/
                ...
                for (i=1; i<=Num_NBO; i++) {
                    ...
                    posi[1] = Posi_a[Gb1_AN];
                    leng[1] = Leng_a[Gb1_AN];
                    posi[2] = Posi_a[Gb2_AN];
                    leng[2] = Leng_a[Gb2_AN];
                    ...
                    for (j=1; j<=Num_NBO; j++) {
                        ...
                        posi[3] = Posi_a[Ga1_AN];
                        leng[3] = Leng_a[Ga1_AN];
                        posi[4] = Posi_a[Ga2_AN];
                        leng[4] = Leng_a[Ga2_AN];
                ...
                for (i=1; i<=Num_LonePair; i++) {
                    ...
                    for (j=1; j<=Num_NBO; j++) {
                        ...
                        posi[2] = Posi_a[Ga1_AN];
                        leng[2] = Leng_a[Ga1_AN];
                        posi[3] = Posi_a[Ga2_AN];
                        leng[3] = Leng_a[Ga2_AN];
