    ...
    NE_T_k_op */ )
{
    ...
    *******************************************/
    ...
    if (debug5) {
        ...
        case 1:
            /* sc */
            Read_in_Lattice[0][0]=1.0;
            Read_in_Lattice[0][1]=0.0;
            Read_in_Lattice[0][2]=0.0;
            Read_in_Lattice[1][0]=0.0;
            Read_in_Lattice[1][1]=1.0;
            Read_in_Lattice[1][2]=0.0;
            Read_in_Lattice[2][0]=0.0;
            Read_in_Lattice[2][1]=0.0;
            Read_in_Lattice[2][2]=1.0;
        ...
        case 2:
            /*bcc */
            Read_in_Lattice[0][0]=-0.5;
            Read_in_Lattice[0][1]=0.5;
            Read_in_Lattice[0][2]=0.5;
            Read_in_Lattice[1][0]=0.5;
            Read_in_Lattice[1][1]=-0.5;
            Read_in_Lattice[1][2]=0.5;
            Read_in_Lattice[2][0]=0.5;
            Read_in_Lattice[2][1]=0.5;
            Read_in_Lattice[2][2]=-0.5;
        ...
        case 3:
            /* fcc */
            Read_in_Lattice[0][0]=0.0;
            Read_in_Lattice[0][1]=1.5;
            Read_in_Lattice[0][2]=1.5;
            Read_in_Lattice[1][0]=1.5;
            Read_in_Lattice[1][1]=0.0;
            Read_in_Lattice[1][2]=1.5;
            Read_in_Lattice[2][0]=1.5;
            Read_in_Lattice[2][1]=1.5;
            Read_in_Lattice[2][2]=0.0;
        ...
        case 4:
            /* hP */
            Read_in_Lattice[0][0]=1.0;
            Read_in_Lattice[0][1]=-1.0;
            Read_in_Lattice[0][2]=0.0;
            Read_in_Lattice[1][0]=-1.0;
            Read_in_Lattice[1][1]=0.0;
            Read_in_Lattice[1][2]=1.0;
            Read_in_Lattice[2][0]=-1.0;
            Read_in_Lattice[2][1]=-1.0;
            Read_in_Lattice[2][2]=-1.0;
        ...
        case 7:
            /* hR  */
            Read_in_Lattice[0][0]=0.7848063699;
            Read_in_Lattice[0][1]=0.2957148683;
            Read_in_Lattice[0][2]=0.544639035;
            Read_in_Lattice[1][0]=0.0;
            Read_in_Lattice[1][1]=0.8386705679;
            Read_in_Lattice[1][2]=0.544639035;
            Read_in_Lattice[2][0]=0.0;
            Read_in_Lattice[2][1]=0.0;
            Read_in_Lattice[2][2]=1.0;
        ...
        case 8:
            /* oP */
            Read_in_Lattice[0][0]=4.0;
            Read_in_Lattice[0][1]=0.0;
            Read_in_Lattice[0][2]=0.0;
            Read_in_Lattice[1][0]=0.0;
            Read_in_Lattice[1][1]=2.0;
            Read_in_Lattice[1][2]=0.0;
            Read_in_Lattice[2][0]=0.0;
            Read_in_Lattice[2][1]=0.0;
            Read_in_Lattice[2][2]=3.0;
        ...
        case 13:
            ...
            Read_in_Lattice[1][1]=1.0;
            Read_in_Lattice[1][2]=1.5;
            Read_in_Lattice[2][0]=0.9993908270;
            Read_in_Lattice[2][1]=-0.0348994967;
            Read_in_Lattice[2][2]=0.0;
        ...
        case 14:
            /* aP triclinic */
            Read_in_Lattice[0][0]= 0.7546287487;
            Read_in_Lattice[0][1]=-0.1317556090;
            Read_in_Lattice[0][2]= 0.6427876097;
            Read_in_Lattice[1][0]= 0.7546287487;
            Read_in_Lattice[1][1]= 1.3309517942;
            Read_in_Lattice[1][2]=-0.9932156702;
            Read_in_Lattice[2][0]=-0.7546287487;
            Read_in_Lattice[2][1]= 1.5944630122;
            Read_in_Lattice[2][2]= 0.7212091104;
    ...
    */
    ...
    for(k=0; k<op_num; k++) {
        if(Gsym_op[k][0][0]==-1&&Gsym_op[k][0][1]==0&&Gsym_op[k][0][2]==0
                ...
                &&Gsym_op[k][2][0]==0&&Gsym_op[k][2][1]==0&&Gsym_op[k][2][2]==-1) {
            inversion_sym=1;
            break;
        }
    }
...
void Symmetry_Operation_Transform(int ***InputSymop, int ***OutputSymop, int op_num,
    ...
    for(k=0; k<op_num; k++) {
        ...
        for(i=0; i<3; i++) {
            for(j=0; j<3; j++) {
                /* printf("FLOAT=%20.18f\n",Osym[i][j]); */
                if(fabs(Osym[i][j]-1.0)<smallvalue) {
                    Osym[i][j]=1.0;
                }
                if(fabs(Osym[i][j]+1.0)<smallvalue) {
                    Osym[i][j]=-1.0;
...
int Chk_Pure_Point_Group_Op(int **exop, double **atomic_position, int *atom_species,
    ...
    */
    ...
    for(atom_indx=start_atom_indx; atom_indx<atom_species[smallest_species]; atom_indx++) {
        ...
        if(fabs(trans_vec[0]-1.0)<smallvalue) {
            trans_vec[0]=0.0;
        }
        if(fabs(trans_vec[1]-1.0)<smallvalue) {
            trans_vec[1]=0.0;
        }
        if(fabs(trans_vec[2]-1.0)<smallvalue) {
            trans_vec[2]=0.0;
        }
        if(debug3==1) {
        ...
        if(trans_vec[0]>(smallvalue+tmp_vec[0])
            ...
            for(atom_type_indx=0; atom_type_indx<atom_type; atom_type_indx++) {
                ...
                for(atom_indx2=start_atom_indx; atom_indx2<end_atom_indx; atom_indx2++) {
                    ...
                    if(fabs(diff_vec[0]-1.0)<smallvalue) {
                        diff_vec[0]=0.0;
                    }
                    if(fabs(diff_vec[1]-1.0)<smallvalue) {
                        diff_vec[1]=0.0;
                    }
                    if(fabs(diff_vec[2]-1.0)<smallvalue) {
                        diff_vec[2]=0.0;
                    }
