    ...
    do {
        ...
        /* if (3<CellOpt_iter) */
            ...
            ************************************************/
            ...
            tv[1][1] = len*tv[1][1]/len0;
            tv[1][2] = len*tv[1][2]/len0;
            tv[1][3] = len*tv[1][3]/len0;

            len0 = sqrt(tv[2][1]*tv[2][1] + tv[2][2]*tv[2][2] + tv[2][3]*tv[2][3]);
            tv[2][1] = len*tv[2][1]/len0;
            tv[2][2] = len*tv[2][2]/len0;
            tv[2][3] = len*tv[2][3]/len0;

            len0 = sqrt(tv[3][1]*tv[3][1] + tv[3][2]*tv[3][2] + tv[3][3]*tv[3][3]);
            tv[3][1] = len*tv[3][1]/len0;
            tv[3][2] = len*tv[3][2]/len0;
            tv[3][3] = len*tv[3][3]/len0;
        }
    ...
    do {
        ...
        /* if (8<CellOpt_iter) */
            ...
            ********************************************************/
            ...
            len0 = sqrt(tv[1][1]*tv[1][1] + tv[1][2]*tv[1][2] + tv[1][3]*tv[1][3]);
            tv[1][1] = A*tv[1][1]/len0;
            tv[1][2] = A*tv[1][2]/len0;
            tv[1][3] = A*tv[1][3]/len0;

            len0 = sqrt(tv[2][1]*tv[2][1] + tv[2][2]*tv[2][2] + tv[2][3]*tv[2][3]);
            tv[2][1] = A*tv[2][1]/len0;
            tv[2][2] = A*tv[2][2]/len0;
            tv[2][3] = A*tv[2][3]/len0;

            len0 = sqrt(tv[3][1]*tv[3][1] + tv[3][2]*tv[3][2] + tv[3][3]*tv[3][3]);
            tv[3][1] = C*tv[3][1]/len0;
            tv[3][2] = C*tv[3][2]/len0;
            tv[3][3] = C*tv[3][3]/len0;
        }
