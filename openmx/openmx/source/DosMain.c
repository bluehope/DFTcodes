    ...
    *****************************************/
    ...
    if (*mode==5) {
        ...
        *Max_tnoA = (*Spe_Total_CNO)[0];
        ...
        N_Spe_Num_CBasis=2;
        i_Spe_Num_CBasis[0]=*SpeciesNum;
        i_Spe_Num_CBasis[1]=*MaxL+1;
        *Spe_Num_CBasis=(int**)malloc_multidimarray("int",N_Spe_Num_CBasis, i_Spe_Num_CBasis);
        ...
        N_Spe_Num_Relation=2;
        i_Spe_Num_Relation[0]=*SpeciesNum;
        i_Spe_Num_Relation[1]=*Max_tnoA;
    ...
    *****************************************/
        ...
        *Spe_Num_Relation=(int**)malloc_multidimarray("int",N_Spe_Num_Relation, i_Spe_Num_Relation);
        ...
        if (fp=input_find("<Eigenvalues") ) {
            N_ko=5;
            i=0;
            i_ko[i++]=*SpinP_switch+1;
            i_ko[i++]=Kgrid[0];
            i_ko[i++]=Kgrid[1];
            i_ko[i++]=Kgrid[2];
            i_ko[i++]= *iemax-*iemin+1;
                ...
                for (j=0; j<Kgrid[1]; j++) {
                    for (k=0; k<Kgrid[2]; k++) {
                        for (spin=0; spin<=*SpinP_switch; spin++) {
                            ...
                            if (i1!=i || j1!=j || k1!=k) {
                            printf("format error in Eigenvalues\n");
                            exit(10);
                                 }
                                 */
                 ...
                 int *pdos_n, int **pdos_atoms)
{
    ...
    if (*method==2) {
        ...
        fgets(buf,1000,stdin);
        sscanf(buf,"%lf",gaussian);
        *gaussian = *gaussian/eV2Hartree;
    }
