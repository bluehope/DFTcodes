            ...
            for (b=0; b<tot_bvector; b++) {
                for (i=0; i<tno0; i++) {
                    for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
                        ...
                        for (j=0; j<tno1; j++) {
                            vec0[num] = OLP_exp[b][Mc_AN][h_AN][i][j].r;
                            num++;
                            vec0[num] = OLP_exp[b][Mc_AN][h_AN][i][j].i;
                            num++;
                        }
                    }
                }
        ...
        for (b=0; b<tot_bvector; b++) {
            for (i=0; i<tno0; i++) {
                for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (j=0; j<tno1; j++) {
                        OLPe[b][Gc_AN][h_AN][i][j].r = vec0[num];
                        num++;
                        OLPe[b][Gc_AN][h_AN][i][j].i = vec0[num];
                        num++;
                    }
                }
            }
             ...
             char *inputfile)
{
    ...
    if (myid==Host_ID) {
        ...
        printf(" Copyright (C), 2006-2008, Hongming Weng, Taisuke Ozaki and Kiyoyuki Terakura\n");
...

        {
            ...
            for( k=0; k<kpt_num; k++ ) {
                ...
                for (spin=0; spin<spinsize; spin++) {
                    for (i=0; i<fsize3; i++) {
                        for (j=0; j<fsize3; j++) {
                            vec0[num] = Wkall[k][spin][i][j].r;
                            num++;
                            vec0[num] = Wkall[k][spin][i][j].i;
                            num++;
                        }
                    }
                }
                ...
                for (spin=0; spin<spinsize; spin++) {
                    for (i=0; i<fsize3; i++) {
                        for (j=0; j<fsize3; j++) {
                            Wkall[k][spin][i][j].r = vec0[num];
                            num++;
                            Wkall[k][spin][i][j].i = vec0[num];
                            num++;
                        }
                    }
                }
...
//        fprintf(fp,"%4s   %18.14f %18.14f %18.14f\n",
    ...
    */
    ...
    if(Wannier_Draw_MLWF) {
        ...
        OutData_WF(inputfile,r_num,rvect);
        fflush(0);
        ...
        for (k=0; k<=SpinP_switch; k++) {
            for (i=0; i<tno0; i++) {
                for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
                    ...
                    for (j=0; j<tno1; j++) {
                        fHks[k][Gc_AN][h_AN][i][j] = vec0[num];
                        num++;
                    }
                }
            }
                ...
                for (k=0; k<List_YOUSO[5]; k++) {
                    for (i=0; i<tno0; i++) {
                        for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
                            ...
                            for (j=0; j<tno1; j++) {
                                vec0[num] = iHks[k][Mc_AN][h_AN][i][j];
                                num++;
                            }
                        }
                    }
            ...
            for (k=0; k<List_YOUSO[5]; k++) {
                for (i=0; i<tno0; i++) {
                    for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
                        ...
                        for (j=0; j<tno1; j++) {
                            fiHks[k][Gc_AN][h_AN][i][j] = vec0[num];
                            num++;
                        }
                    }
                }
        ...
        for(k=0; k<kpt_num; k++) { /* kpt */
            ...
            for(nindx=0; nindx<wan_num; nindx++) { /*wan_num */
                for(mu1=0; mu1<band_num; mu1++) { /* band index */
                    Uk[spin][k][mu1][nindx].r=0.0;
                    Uk[spin][k][mu1][nindx].i=0.0;
            ...
            if(debug31) {
                ...
                for(mu1=0; mu1<band_num; mu1++) {
                    for(j=0; j<wan_num; j++) {
                        ...
                        Amatrix[mu1][j].r=sumr;
                        Amatrix[mu1][j].i=sumi;
                ...
                for(mu1=0; mu1<band_num; mu1++) {
                    for(j=0; j<wan_num; j++) {
                        ...
                        Dmatrix[mu1][j].r=sumr;
                        Dmatrix[mu1][j].i=sumi;
...
void Shell_Structure(double **klatt, int *M_s, int **bvector, int *shell_num, int MAXSHELL) {
    ...
    */
    ...
    i=0;
    dx=distance[0]; /*mark the first shell */
    current_shell=0;
        ...
        for(i=0; i<band_num-Mk; i++) { /* we must ignore the Mk number of frozen states */
            if(Mk>0) {
                if((i+1+nbandwin[presentk][0])<(nbandfroz[presentk][0]+1)) { /* if the i state is between two bottoms of outer and inner window */
                    ...
                    /* if(i+1+nbandwin[k][0]>nbandfroz[k][1]) */ /* if i state is between tow tops of outter and inner windwo */
            ...
            for(j=0; j<band_num-Mk; j++) {
                if(Mk>0) {
                    if(j+1+nbandwin[presentk][0]<nbandfroz[presentk][0]+1) { /* if the j state is between two bottoms of outer and inner window */
                        ...
                        /* if(j+1+nbandwin[k][0]>nbandfroz[k][1]) */ /* if i state is between tow tops of outter and inner windwo */
