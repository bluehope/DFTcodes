    ...
    ***********************************************/
    ...
    for (Mc_AN=1; Mc_AN<=Matomnum; Mc_AN++) {
        ...
        for (h_AN=0; h_AN<=FNAN[Gc_AN]; h_AN++) {
            OneD_Nloop++;
            if(ai_MaxNc < GridN_Atom[Gc_AN]) {
                ai_MaxNc = GridN_Atom[Gc_AN];
            }
        }
    }
    ...
    ******************************************************/
    ...
    for (ID=0; ID<NN_B2D_S; ID++) {
        ...
        for (LN=0; LN<Num_Snd_Grid_B2D[IDS]; LN++) {
            ...
            if (SpinP_switch==0) {
                Work_Array_Snd_Grid_B2D[gp+LN]       = Density_Grid_B[0][BN];
            }
            else if (SpinP_switch==1) {
                Work_Array_Snd_Grid_B2D[2*gp+2*LN+0] = Density_Grid_B[0][BN];
                Work_Array_Snd_Grid_B2D[2*gp+2*LN+1] = Density_Grid_B[1][BN];
            }
            else if (SpinP_switch==3) {
                Work_Array_Snd_Grid_B2D[4*gp+4*LN+0] = Density_Grid_B[0][BN];
                Work_Array_Snd_Grid_B2D[4*gp+4*LN+1] = Density_Grid_B[1][BN];
                Work_Array_Snd_Grid_B2D[4*gp+4*LN+2] = Density_Grid_B[2][BN];
                Work_Array_Snd_Grid_B2D[4*gp+4*LN+3] = Density_Grid_B[3][BN];
            }
        } /* LN */
    ...
    ************************************/
    ...
    #pragma omp parallel shared(Density_Grid_B,My_NumGridB_AB) private(OMPID,Nthrds,BN,Re11,Re22,Re12,Im12,Nup,Ndown,theta,phi)
    {
        ...
        for (BN=OMPID; BN<My_NumGridB_AB; BN+=Nthrds) {
            ...
            Re11 = Density_Grid_B[0][BN];
            Re22 = Density_Grid_B[1][BN];
            Re12 = Density_Grid_B[2][BN];
            Im12 = Density_Grid_B[3][BN];

            EulerAngle_Spin( 1, Re11, Re22, Re12, Im12, Re12, -Im12, Nup, Ndown, theta, phi );

            Density_Grid_B[0][BN] = Nup[0];
            Density_Grid_B[1][BN] = Ndown[0];
            Density_Grid_B[2][BN] = theta[0];
            Density_Grid_B[3][BN] = phi[0];
        }
