/**********************************************************************
  add_gcube.c
     ...
     add_gcube.c is a program which calculates the sum of two densities
     stored in Gaussian cube files, and output the result
     to a file in the Gaussian cube format.

      Usage:

         ./add_density input1.cube input2.cube output.cube
