...
double Cluster_Col_Dosout( int SpinP_switch,  double *****nh, double ****CntOLP)
{
    ...
    int N_C, i_C[10];
    double **Ctmp;
    int N_Ctmp, i_Ctmp[10];
    double ****CDM;
    int N_CDM=4,i_CDM[10];
    double **SD;
    int N_SD=2, i_SD[10];
    ...
    double **Ovlp;
    int N_Ovlp, i_Ovlp[10];
    double **Sinv;
    int N_Sinv, i_Sinv[10];
    double ***J;
    int N_J, i_J[10];
    FILE *fp_opt;
    ...
    ****************************************************/
    ...
    N_CDM=4;
    i_CDM[0]=Matomnum+1;
    i_CDM[1]=List_YOUSO[8];
    i_CDM[2]=List_YOUSO[7];
    i_CDM[3]=List_YOUSO[7];
                              ...
                              double ****CntOLP)
{
    ...
    ****************************************************/
    ...
    i_CDM[0]=4;
    i_CDM[1]=Matomnum+1;
    i_CDM[2]=List_YOUSO[8];
    i_CDM[3]=List_YOUSO[7];
    i_CDM[4]=List_YOUSO[7];
    CDM =(double*****)malloc_multidimarray("double",N_CDM,i_CDM);
